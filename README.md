...
![DevSecOps+GitOps](https://github.com/user-attachments/assets/ff323885-76fd-46c8-8a90-08c75bbfab7e)
...
![277722443-17ba9da6-225f-481d-87c0-5d5a010a9538](https://github.com/user-attachments/assets/35c4b5cd-f180-473f-9756-b0f2f70ddfa1)
#
...
![jenkins-ci](https://github.com/user-attachments/assets/25593b11-1d61-4d1f-afb4-e53037f5b240)


- <b>CD pipeline to update application version</b>
![jenkins-cd](https://github.com/user-attachments/assets/7993aecc-5b4b-4cf4-b138-a4e9af259011)


- <b>ArgoCD application for deployment on EKS</b>
![argocd-app-deploy](https://github.com/user-attachments/assets/6fb3504c-8986-4c88-872a-e1d9ea285660)
...
- <b id="Argo">Install and Configure ArgoCD (Master Machine)</b>
  ...
  ![argocd-svcs](https://github.com/user-attachments/assets/db241ff4-9e06-4780-895b-f951c6361d88)

  - <b>Access it on browser, click on advance and proceed with</b>
  ```bash
  <public-ip-worker>:<port>
  ```
  ![argocd-access](https://github.com/user-attachments/assets/09d01994-2631-4951-890a-d3e5ddd9b513)
  ![argocd-access1](https://github.com/user-attachments/assets/8943c4a9-0c37-4330-8252-5204eadcf26f)
  ![argocd-access2](https://github.com/user-attachments/assets/6c4127df-12a4-4e75-b3d8-d47dab9533f5)
...
![image](https://github.com/user-attachments/assets/a3d31ff1-f816-48d8-a8af-eff6373e7177)


# 
- <b> Go back to <mark>Manage Jenkins --> System</mark> and search for <mark>Extended E-mail Notification</mark></b>
![image](https://github.com/user-attachments/assets/be95c886-a735-4ab1-862f-3150da57e091)
...
![image](https://github.com/user-attachments/assets/a38113f3-3c3a-4ec5-b841-a5560cb6e3aa)
![image](https://github.com/user-attachments/assets/f8671f5d-af4e-4841-bf17-f9464314edf0)
![image](https://github.com/user-attachments/assets/f97ab439-5a5e-40da-bb76-749bc676ce09)
...
![image](https://github.com/user-attachments/assets/37587dc7-a5ee-4118-86c7-e54af95dde73)
...
![image](https://github.com/user-attachments/assets/d21ff2ea-8b01-4306-86c3-0f19398e8cdb)

#
- <b>Navigate to <mark> Manage Jenkins --> credentials</mark> and add credentials for docker login to push docker image:</b>
![image](https://github.com/user-attachments/assets/659f8cff-e3d1-4ee6-9ae3-20ed8b335aa9)
...
![image](https://github.com/user-attachments/assets/0160da41-0d94-43ea-b726-17bf162a66d8)
...
![image](https://github.com/user-attachments/assets/8d8901a6-8339-407a-8c07-ed4262286ad6)
![image](https://github.com/user-attachments/assets/8e9ae10d-5fdb-4352-b782-0946cc10bbce)
...
![image](https://github.com/user-attachments/assets/22de177b-5ce7-418e-941f-18533a5b7654)


> [!Important]
> Make sure to click on the <mark>Auto-Create Namespace</mark> option while creating argocd application

![image](https://github.com/user-attachments/assets/251d206e-7f7f-4478-b084-9909d91e0665)


- <b>Congratulations, your application is deployed on AWS EKS Cluster</b>
![image](https://github.com/user-attachments/assets/58715ba9-57aa-446a-8b19-ab55a00ca15e)

![argocd-app-deploy](https://github.com/user-attachments/assets/7eea1886-1d7c-497c-aad9-d9fc4683795b)

- <b>Open port 31000 and 31100 on worker node and Access it on browser</b>
```bash
<worker-public-ip>:31000
```
![image](https://github.com/user-attachments/assets/8ccf6c0e-532a-4136-bd22-0dcf594f43e2)

![image](https://github.com/user-attachments/assets/bab29cf7-e70d-4c46-a2b0-72f920e5a828)


- <b>Email Notification</b>

![image](https://github.com/user-attachments/assets/0cbb5413-4f9e-4e2b-a1d8-327ecc079e35)
...
![grafana-monitoring](https://github.com/user-attachments/assets/3a993c40-ccf1-4829-82ae-963bbab62b2c)
